...
exports.paymentRouter = (0, trpc_1.router)({
    ...
    createSession: trpc_1.privateProcedure.input(zod_1.z.object({ productIds: zod_1.z.array(zod_1.z.string()) })).mutation(function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var user, productIds, payload, products, filterProducts, order, line_items, stripeSession, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        filterProducts = products.filter(function (prod) { return Boolean(prod.priceId); });
                    ...
                    case 3:
                        ...
                        line_items.push({
                            price: "price_1OYD84A1nDExU7YjEtXZXZpZ",
                            quantity: 1,
                            adjustable_quantity: {
                                enabled: false
                            }
